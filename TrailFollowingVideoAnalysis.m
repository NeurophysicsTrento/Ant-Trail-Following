...
clear all;close all
inpath='\\cimec-storage\albhaa\haaalb001a1p\Florencia\ej videos\'; %raw video input path
infile='MVI_2524'% raw video input file name
outpath='G:\My Drive\Data\Ants\AntTrailFollowing\ej videos\'; %labelled video output path
...
%% 4) Find ant position via intensity thresholding
%ant in time
[minant,maxpos]=min(gbin,[],[1 2],'linear'); %signal and linear position ant
...
%% 5) Find and correct trail intensity and position
...
%% 6) Verify intensities and positions
